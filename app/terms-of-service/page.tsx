...
const terms = [
  ...
  },
  {
    ...
    body: [
      ...
      "Unless a product listing expressly states and labels a device as Brand New, most store devices are supplied as A+ grade renewed. The product condition shown on the listing and confirmed before payment forms part of the order terms.",
