        ...
        <section className="rounded-lg border border-line bg-white p-5 shadow-lift xl:sticky xl:top-4">
          ...
          >
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <label>Condition<select value={draft.condition} onChange={(event) => setDraft((current) => ({ ...current, condition: event.target.value as ProductCondition }))}><option value="BRAND_NEW">Brand New</option><option value="REFURBISHED">A+ Grade Renewed</option><option value="OPEN_BOX">Open Box</option></select></label>
